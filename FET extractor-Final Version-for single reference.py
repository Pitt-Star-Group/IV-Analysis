...
for i in range (0,len(sample)):   
    ...
    p5=(sin6-in6)/yvth       #dg/gvth@-0.6    g is yvth
    p6=(si4-i4)/yvth         #dg/gvth@0.4     g is yvth
    p7=(sin4-in4)/yvth       #dg/gvth@-0.4     g is yvth
    p8=(si3-i3)/yvth         #dg/gvth@0.3     g is yvth
    p9=(sin3-in3)/yvth       #dg/gvth@-0.3     g is yvth
    p10=(si6-i6)/i6          #dg/g@0.6v
    p11=(sin6-in6)/in6       #dg/g@-0.6
    print p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, ssample[i]
